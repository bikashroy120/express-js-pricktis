...
const { regester, getUser, getOneUser, deteleUser, varfyEmailInRegester, updateUser, logInUser, userLogOut, BannedUser, unBannedUser, changePasssword } = require("../contoraler/userControler")
